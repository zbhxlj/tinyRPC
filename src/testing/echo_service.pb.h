...
class EchoRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tinyRPC.testing.EchoRequest) */ {
 public:
  EchoRequest();
  virtual ~EchoRequest();
...
class EchoResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tinyRPC.testing.EchoResponse) */ {
 public:
  EchoResponse();
